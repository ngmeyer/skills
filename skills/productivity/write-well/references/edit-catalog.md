# Edit Catalog — AI patterns and how to fix them

Reference for `write-well` **edit mode**: recurring AI-writing patterns with before/after fixes, based on [Wikipedia's "Signs of AI writing"](https://en.wikipedia.org/wiki/Wikipedia:Signs_of_AI_writing) (WikiProject AI Cleanup). Order matters — **add voice first** (the PERSONALITY AND SOUL section below), *then* subtract these patterns. A draft scrubbed clean of every pattern but still flat and opinion-free is not fixed.
